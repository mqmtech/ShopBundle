...
use MQM\OrderBundle\Entity\Order;
...
class OrderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MQMShopBundle:Shop\Order')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Shop\Order')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Order:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Order:edit.html.twig")
     */
