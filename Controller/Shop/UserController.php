...
use MQM\ShopBundle\Form\Shop\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MQMShopBundle:Shop\User')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Shop\User')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\User:new.html.twig")
     */
