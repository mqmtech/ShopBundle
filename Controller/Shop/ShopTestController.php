...
class ShopTestController extends Controller {
	...
	public function testCreateProductBrandAction() {
		...
		//Get/Create Brand
		$brandName = "Adidas";
		$q = $em->createQuery("select brand from MQMShopBundle:Shop\\Brand brand WHERE brand.name = '".$brandName."' ");
		try {
		...
		$q = $em->createQuery("select p from MQMShopBundle:Shop\\Product p WHERE p.name = '".$prodName."' ");
		try {
	...
	public function testCreateCatCatAction() {
		...
		$q = $em->createQuery("select cat from MQMShopBundle:Shop\Category cat WHERE cat.name = '".$catName."' ");
		try {
...
//		}
	...
	public function indexAction() {
		...
		$entities = $em->getRepository ( 'MQMShopBundle:Shop\Category' )->findAll ();
