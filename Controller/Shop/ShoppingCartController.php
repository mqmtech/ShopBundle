...
class ShoppingCartController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MQMShopBundle:Shop\ShoppingCart')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Shop\ShoppingCart')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\ShoppingCart:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\ShoppingCart:edit.html.twig")
     */
