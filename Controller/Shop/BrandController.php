...
use MQM\ShopBundle\Form\Shop\BrandType;
...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MQMShopBundle:Shop\Brand')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Shop\Brand')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Brand:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Brand:edit.html.twig")
     */
