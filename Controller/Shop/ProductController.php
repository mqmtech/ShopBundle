...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MQMShopBundle:Shop\Product')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Shop\Product')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Product:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Product:edit.html.twig")
     */
