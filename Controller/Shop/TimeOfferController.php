...
use MQM\ShopBundle\Entity\TimeOffer;
use MQM\ShopBundle\Form\Shop\TimeOfferType;
...
class TimeOfferController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MQMShopBundle:Shop\TimeOffer')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Shop\TimeOffer')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\TimeOffer:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\TimeOffer:edit.html.twig")
     */
