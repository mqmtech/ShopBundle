...
class CategoryController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Shop\Category')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Category:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Shop\Category:edit.html.twig")
     */
