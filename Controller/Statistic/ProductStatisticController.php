...
namespace MQM\ShopBundle\Controller\Statistic;
...
class ProductStatisticController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MQMShopBundle:Statistic\ProductStatistic')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MQMShopBundle:Statistic\ProductStatistic')->find($id);
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Statistic\ProductStatistic:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("MQMShopBundle:Statistic\ProductStatistic:edit.html.twig")
     */
